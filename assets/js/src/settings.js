(function($) {
	var $enableInMemoryCache = $( document.getElementById( 'vc_enable_in_memory_object_caching' ) );
	...
	var $advancedModeToggle = $( document.getElementById( 'vc_advanced_mode' ) );
	var advancedTable = document.querySelectorAll( '.vc-advanced-mode-table' )[0];
	var simpleTable = document.querySelectorAll( '.vc-simple-mode-table' )[0];
	var pageCachingSimple = document.getElementById( 'vc_enable_page_caching_simple' );
	var pageCachingAdvanced = document.getElementById( 'vc_enable_page_caching_advanced' );
	var pageCacheLengthSimple = document.getElementById( 'vc_page_cache_length_simple' );
	var pageCacheLengthAdvanced = document.getElementById( 'vc_page_cache_length_advanced' );
	var gzipCompressionSimple = document.getElementById( 'vc_enable_gzip_compression_simple' );
	var gzipCompressionAdvanced = document.getElementById( 'vc_enable_gzip_compression_advanced' );
